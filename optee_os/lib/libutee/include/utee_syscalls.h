...
ssize_t utee_tzvfs_read(int *tzvfs_errno, int fd, void *buf, size_t count,  off_t offset, int whence);

ssize_t utee_tzvfs_write(int *tzvfs_errno, int fd, const void *buf, size_t count,  off_t offset, int whence);
